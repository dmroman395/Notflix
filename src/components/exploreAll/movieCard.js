...
function MovieCard({ movie, movies, lang, selectedMovie, setSelectedMovie, similarMovies, setSimilarMovies, watchlist, setWatchlist, setExploreMovies}) {
